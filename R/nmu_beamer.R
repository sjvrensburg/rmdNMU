#' NMU Beamer Presentation Format
#'
#' Format for creating NMU-branded presentations using Beamer with faculty
#' color themes.
#'
#' @param theme NMU faculty theme. Options: "sciences", "business", "humanities", 
#'   "education", "health", "engineering", "law", "ocean"
...
#' @param ... Additional arguments passed to \code{\link[rmarkdown]{beamer_presentation}}
#'
...
#' \dontrun{
#' library(rmarkdown)
#' render("input.Rmd", nmu_beamer(theme = "sciences"))
#' }
#'
#' @export
nmu_beamer <- function(theme = "sciences",
                      fig_width = 10,
                      fig_height = 7,
                      fig_crop = TRUE,
                      fig_caption = TRUE,
  ...
  # Validate theme
  valid_themes <- c("sciences", "business", "humanities", "education", 
                   "health", "engineering", "law", "ocean")
  if (!theme %in% valid_themes) {
    warning("Invalid theme '", theme, "'. Using 'sciences' instead.")
    theme <- "sciences"
  }
  
  # Get template path
  template_path <- system.file("rmarkdown/templates/nmu_beamer/resources/template.tex", 
                              package = "rmdNMU")
  ...
  rmarkdown::beamer_presentation(
    ...
    pandoc_args = c(pandoc_args, 
                   ...
                   paste0("--variable=nmu_theme:", theme)),
