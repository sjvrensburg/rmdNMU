#' NMU Document Format
#'
#' Format for creating NMU-branded academic documents including short notes,
...
#' \dontrun{
#' library(rmarkdown)
#' render("input.Rmd", nmu_document())
#' }
#'
#' @export
nmu_document <- function(toc = FALSE,
  ...
  # Get template path
  template_path <- system.file("rmarkdown/templates/nmu_document/resources/template.tex", 
                              package = "rmdNMU")
  ...
  rmarkdown::pdf_document(
    ...
    pandoc_args = c(pandoc_args, paste0("--variable=fontdir:", font_dir)),
