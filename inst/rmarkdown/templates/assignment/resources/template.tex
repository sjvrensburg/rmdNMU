...
%   ./inst/rmarkdown/templates/assignment/resources/template.tex
$if(params.solutions)$
...
% Pandoc compatibility and conflict prevention
\providecommand{\tightlist}{%
  \setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}}

% Prevent command redefinition errors
\providecommand{\VerbBar}{|}
\providecommand{\VERB}{}
\providecommand{\Coloneqq}{\coloneqq}

% Conditional theorem environments
